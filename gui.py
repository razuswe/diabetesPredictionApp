...
class Diabetes(QWidget):
    ...
    def __init__(self) -> None :
        ...
        self.t6 = QLabel("Serum insulin:")
        self.t7 = QLabel("Serum insulin:")
...
\nDiastolic blood pressure: {}\nTriceps skin fold thickness: {}\nSerum insulin: {}\nBody mass index: {}".format(self.l0.text(), self.l1.text(), self.l2.text(), self.l3.text(),self.l4.text(),self.l5.text()))
        #
        if output==0:
            self.results.setText("Diagnosis suggests that patient does not suffers from ASD.")
        else:
            self.results.setText("Our diagnosis suggests patient does suffer from ASD.\n Please get checked soon.")
    ...
    def mwindow(self) -> None:
        ...
        self.setWindowTitle("Early Detection of ASD")
        self.show()
